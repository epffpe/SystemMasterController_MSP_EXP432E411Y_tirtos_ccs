...
static char *g_ppcUSBArgv[CMDLINE_MAX_ARGS + 1];
static char *g_ppcTCPArgv[CMDLINE_MAX_ARGS + 1];
//*****************************************************************************
//
...
//
//*****************************************************************************
//int CmdLineProcess(UART_Handle uart, char *pcCmdLine)
//{
//    char *pcChar;
...
//                return (psCmdEntry->pfnCmd(uart, ui8Argc, g_ppcArgv));
//            }
//
//            //
...
int CmdLineProcessUSB(char *pcCmdLine)
{
    char *pcChar;
    uint_fast8_t ui8Argc;
    bool bFindArg = true;
    ...
    if (ui8Argc) {
        ...
        while (psCmdEntry->pcCmd) {
            ...
            // arguments.
            //
            if (!strcmp(g_ppcUSBArgv[0], psCmdEntry->pcCmd)) {
                return (psCmdEntry->pfnCmd(ui8Argc, g_ppcUSBArgv));
            }
...
int CmdLineProcessTCP(int sockfd, char *pcCmdLine)
{
    char *pcChar;
    uint_fast8_t ui8Argc;
    bool bFindArg = true;
