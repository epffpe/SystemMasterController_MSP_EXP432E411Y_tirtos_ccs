...
typedef enum
{
    ...
    CHARACTERISTIC_TCPRCBIN_ADVS_SERIAL_STEVE_COMMAND_VIDEO_CHANNEL_SET_ID,
    CHARACTERISTIC_TCPRCBIN_ADVS_SERIAL_STEVE_COMMAND_CHANNEL_GET_ID,
    CHARACTERISTIC_TCPRCBIN_ADVS_SERIAL_STEVE_COMMAND_VIDEO_CHANNEL_GET_ID,
    ...
    CHARACTERISTIC_TCPRCBIN_ADVS_SERIAL_STEVE_COMMAND_TREBLE_SET_ID,
    CHARACTERISTIC_TCPRCBIN_ADVS_SERIAL_STEVE_COMMAND_TREBLE_GET_ID,
