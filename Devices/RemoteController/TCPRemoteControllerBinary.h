...
#define TCPBINDEVICE_NUMTCPWORKERS         5
...
typedef enum
{
    ...
    SERVICE_TCPBIN_REMOTECONTROL_AVDS_CLASS_RETURN_UUID,
    SERVICE_TCPBIN_REMOTECONTROL_AVDS_SERIAL_CLASS_RETURN_UUID,
    SERVICE_TCPBIN_REMOTECONTROL_ROSEN_SERVICE_RETURN_UUID,
